# 📝 365. Water and Jug Problem (LeetCode)
...
### 💡 Tags
Math, Depth-First Search, Breadth-First Search, Bézout's Lemma, Euclidean Algorithm, Greatest Common Divisor, Extended Euclidean Algorithm
